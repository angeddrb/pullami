...
const row = (es: string, enLabel: string, vEs: string, vEn: string): DataRow => ({
  label: { es, en: enLabel },
  value: { es: vEs, en: vEn },
});
...
export const products: Product[] = [
    ...
    blocks: [
      {
        ...
        items: ['Duke', 'Blue Ribbon', 'Suzi Blue', 'Legacy', 'Brigitta', 'Bringwell', 'Tifblue'],
      },
      { type: 'availability', scientificName: 'Vaccinium Corymbosum', monthsActive: [1, 2, 11, 12], image: 'arandanos-disponibilidad' },
      {
        type: 'markets',
        pins: [
          { label: { es: 'Canadá', en: 'Canada' }, x: 20, y: 30 },
          { label: { es: 'EE.UU.', en: 'USA' }, x: 19, y: 42 },
          { label: { es: 'Inglaterra', en: 'England' }, x: 46, y: 30 },
          { label: { es: 'Holanda', en: 'Netherlands' }, x: 49, y: 31 },
          { label: { es: 'Alemania', en: 'Germany' }, x: 51, y: 33 },
          { label: { es: 'China', en: 'China' }, x: 75, y: 42 },
        ],
      },
      {
        type: 'nutrition',
      ...
      },
      {
        ...
        rows: [
          ...
          row('Lípidos', 'Fats', 'Saturado 0 g · Poliinsaturado 0 g · Monoinsaturado 0 g', 'Saturated 0 g · Polyunsaturated 0 g · Monounsaturated 0 g'),
          row('Colesterol', 'Cholesterol', '0 mg', '0 mg'),
          row('Sodio', 'Sodium', '1 mg', '1 mg'),
          row('Potasio', 'Potassium', '78 mg', '78 mg'),
          row('Glúcidos', 'Carbohydrates', 'Fibra 1,6 gr · Azúcar 8 g', 'Fiber 1.6 g · Sugar 8 g'),
      ...
      },
      {
        ...
        items: [
          { name: { es: 'Global Gap', en: 'Global Gap' }, detail: { es: 'versión 5.2', en: 'version 5.2' }, logo: 'cert-globalgap' },
          { name: { es: 'Protocolo global', en: 'Global protocol' }, detail: { es: 'de buenas prácticas agrícolas', en: 'of good agricultural practices' }, logo: 'cert-bpa' },
          { name: { es: 'FSMA', en: 'FSMA' }, detail: { es: 'versión 1.2', en: 'version 1.2' }, logo: 'cert-fsma' },
        ],
      },
    ],
  },
  ...
  /* ------------------------------ NUECES -------------------------- */
  {
    ...
    blocks: [
      ...
      { type: 'availability', scientificName: 'Juglans Regia', monthsActive: [4, 5], image: 'nueces-disponibilidad' },
      { type: 'imageBand', image: 'nueces-banda-1', alt: { es: 'Nogal con frutos', en: 'Walnut tree with fruit' } },
      {
        type: 'nutrition',
      ...
      { type: 'imageBand', image: 'nueces-banda-2', alt: { es: 'Planta de secado', en: 'Drying facility' } },
      {
        type: 'process',
        variant: 'columns',
        items: [
  ...
  /* ----------------------------- AVELLANAS ------------------------ */
  {
    ...
    blocks: [
      ...
      { type: 'imageBand', image: 'avellanas-banda-1', alt: { es: 'Avellanas en bol', en: 'Hazelnuts in a bowl' } },
      {
        type: 'nutrition',
      ...
      { type: 'imageBand', image: 'avellanas-banda-2', alt: { es: 'Planta de proceso', en: 'Processing facility' } },
      {
        type: 'process',
        variant: 'columns',
        items: [
  ...
  /* ------------------------------ CEREZAS ------------------------- */
  {
    ...
    blocks: [
      ...
      { type: 'availability', scientificName: 'Prunus Avium', monthsActive: [1, 12], image: 'cerezas-disponibilidad' },
      { type: 'imageBand', image: 'cerezas-banda-1', alt: { es: 'Cerezos con fruta', en: 'Cherry trees with fruit' } },
      {
        type: 'nutrition',
      ...
      },
      {
        ...
        rows: [
          ...
          row('Lípidos', 'Fats', 'Saturado 0,1 g · Poliinsaturado 0,1 g · Monoinsaturado 0,1 g', 'Saturated 0.1 g · Polyunsaturated 0.1 g · Monounsaturated 0.1 g'),
          row('Colesterol', 'Cholesterol', '0 mg', '0 mg'),
          row('Sodio', 'Sodium', '3 mg', '3 mg'),
          row('Potasio', 'Potassium', '173 mg', '173 mg'),
          row('Glúcidos', 'Carbohydrates', 'Fibra 1,6 g · Azúcar 8 g', 'Fiber 1.6 g · Sugar 8 g'),
